...
namespace Vigilance.API
{
	public static class Map
	{
		...
		public static SeedSynchronizer SeedSynchronizer => LocalComponents.SeedSync;
		...
		public static void Broadcast(string message, int duration, bool mono = false) => LocalComponents.Broadcast.RpcAddElement(message, (ushort)duration, mono ? global::Broadcast.BroadcastFlags.Monospaced : global::Broadcast.BroadcastFlags.Normal);
		public static void Broadcast(Broadcast bc) => Broadcast(bc.Message, bc.Duration, bc.Monospaced);
		public static void ClearBroadcasts() => LocalComponents.Broadcast.RpcClearElements();

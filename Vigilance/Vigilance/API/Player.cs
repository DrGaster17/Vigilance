...
namespace Vigilance.API
{
    public class Player
    {
        ...
        public bool IsConnected => _refHub.Ready && Role != RoleType.None;
        ...
        public void Broadcast(string message, int duration, bool monospaced) => LocalComponents.ReferenceHub.GetComponent<global::Broadcast>().TargetAddElement(Connection, message, (ushort)duration, monospaced ? global::Broadcast.BroadcastFlags.Monospaced : global::Broadcast.BroadcastFlags.Normal);
        public void Broadcast(Broadcast bc) => Broadcast(bc.Message, bc.Duration, bc.Monospaced);

        public void ClearBroadcasts() => LocalComponents.ReferenceHub.GetComponent<global::Broadcast>().TargetClearElements(Connection);
        ...
        public T GetComponent<T>() where T : Component => _refHub.gameObject.GetComponent<T>();
        public T AddComponent<T>() where T : Component => _refHub.gameObject.AddComponent<T>();

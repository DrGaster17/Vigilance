...
namespace Vigilance.API
{
    public class Generator
    {
        ...
        public void Insert(Player player = null)
        {
            ...
            if (player == null)
                LocalComponents.Player.AddItem(ItemType.WeaponManagerTablet);

            _gen.Interact(player == null ? LocalComponents.Player.GameObject : player.GameObject, PlayerInteract.Generator079Operations.Tablet);
        }

        public void Interact(Player player, PlayerInteract.Generator079Operations operation) => _gen.Interact(player == null ? LocalComponents.Player.GameObject : player.GameObject, operation);

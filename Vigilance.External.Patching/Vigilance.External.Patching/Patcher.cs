...
namespace Vigilance.External.Patching
{
    public static class Patcher
    {
        ...
        public static List<string> DisabledPatches = new List<string>();
        public static API.Version RequiredVersion = new API.Version(6, 0, 0, "RC2", false);

        public static void Patch()
        {
            try
            {
                if (PluginManager.Version.GetHashCode() != RequiredVersion.GetHashCode())
                {
                ...
                if (_instance == null)
                    _instance = HarmonyInstance.Create("vigilance.external.patching.patcher");

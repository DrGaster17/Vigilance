...
namespace Vigilance.Utilities
{
	public static class Directories
	{
		...
		public static string VigilanceExtensionsFile => $"{Vigilance}/Vigilance.Extensions.dll";
		public static string VigilanceUtilitiesFile => $"{Vigilance}/Vigilance.Utilities.dll";
		public static string VigilancePatchesFile => $"{Vigilance}/Vigilance.Patching.dll";
		...
		public static void Startup()
        {
			...
			if (!System.IO.File.Exists(HarmonyFile))
				Download(HarmonyDownloadURL, HarmonyFile);

			if (!System.IO.File.Exists(NewtonsoftJson))
				Download(NewtonsoftDownloadURL, NewtonsoftJson);

			if (!System.IO.File.Exists(Yaml))

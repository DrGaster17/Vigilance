...
namespace Vigilance.Extensions
{
	...
	public static class ItemExtensions
	{
		...
		{
			return CompCache.Inventory.SetPickup(itemType, durability, position, rotation, sight, barrel, other);
		}
	...
	public static class EnumExtensions
	{
		...
		{
			foreach (T t in Common.GetEnums<T>())
			{

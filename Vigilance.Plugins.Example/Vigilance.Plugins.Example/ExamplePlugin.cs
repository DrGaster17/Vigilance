...
// For plugin extensions like adding commands or event handlers - Vigilance.Extensions.dll
...
namespace Vigilance.External.Example
{
    ...
    public class EventHandler : IHandlerWaitingForPlayers, IHandlerPlayerSpawn, IHandlerRoundStart
    {
        ...
        public void OnSpawn(PlayerSpawnEvent ev)
        {
            ...
            ev.Player.Broadcast($"You spawned as a {ev.Role} with {ev.Player.Health} health and {ev.Player.Items.Count()} items.", 10, true);
        }
